...
`<div class='flex flex-col gap-6 leading-[1.4] my-6 text-[0.625rem] tracking-wider'>
  <p>
    The security of the information that customers delegate to Zara.com is one of our top priorities, which is why we invest a great deal of resources and use the latest technology available to ensure that your payment details are processed in a secure setting.
  </p>
  <p>
