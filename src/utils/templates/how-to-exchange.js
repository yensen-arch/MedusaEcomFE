...
<div id="conditions" class="flex flex-col gap-6 my-6">
    <h4>CONDITIONS FOR MAKING AN EXCHANGE</h4>
    <ul class="list-disc flex flex-col gap-4">
        <li class="leading-[2]">
            <p>
                You must manage the exchange before the established date.
            </p>
        ...
        <li>
            You have to make the exchange in the same market/region where you made the purchase.
        </li>
    </ul>
    <p>
