...
`<div class='flex flex-col gap-6 leading-[1.4] my-6 text-[0.625rem] tracking-wider'>
  ...
  <ul class="list-disc flex flex-col gap-6">
    ...
    <li>
      You can track your order on your account.  If you have made a guest purchase, you can do so accessing the link that appears in any of the emails we send you about your order.
    </li>
  </ul>
</div>`
